    ...
    <div>
      ...
      <main className="min-h-screen bg-neutral-900 flex flex-col items-center justify-center text-white px-40 py-24">
        <p className="font-semibold text-7xl">
          <span className=" underline-offset-4 decoration-orange-500 decoration-4 underline">Election</span> <span className=" underline-offset-4 decoration-white decoration-4 underline">Commission</span> <span className=" underline-offset-4 decoration-green-700 decoration-4 underline">Portal</span>
        </p>
